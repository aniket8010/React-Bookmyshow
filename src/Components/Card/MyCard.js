  ...
  return (
    <div>
      ...
      <div className="a_bottom_card mt-3 ps-2">
        <h5 className='a_h19'>{(name?.length < 24 || !isNameSlice) ? name : `${name.slice(0, 24)}...`}</h5>
        <h6 className='roboto-regular a_h14 my-1 text-muted'>{(title1?.length < 18 || !isTitle1Slice) ? title1 : `${title1.slice(0, 18)}...`}</h6>
